import {AggFunc, OmAggregationFunction, CompOper, CompareOperator, WhereClauseRelationship, WhereRel, OrderByDirection, OrderByDir, DistinctModifier, UnionMode} from "./Enums";
...
export class Utils {
  ...
  static ConvertOrderByDir(orderByDir: OrderByDir): OrderByDirection {
    switch (orderByDir) {
